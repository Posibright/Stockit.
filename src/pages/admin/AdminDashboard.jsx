...
import UserManagement from '../../components/UserManagement'; // ✨ NEW: Import the User Management component
...
const AdminDashboard = () => {
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case 'users': // ✨ NEW: Case for the Users Tab
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <header className="mb-8 flex justify-between items-center">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Admin Dashboard: {currentView.charAt(0).toUpperCase() + currentView.slice(1)}</h1>
            ...
            <div className="flex border-b border-gray-200 mb-8">
              ...
              <TabButton view="users" label="Users" /> {/* ✨ NEW: Users Tab */}
            </div>
